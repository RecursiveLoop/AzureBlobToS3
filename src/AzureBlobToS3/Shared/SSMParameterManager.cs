...
namespace Shared
{
    ...
    {
        static Amazon.SimpleSystemsManagement.AmazonSimpleSystemsManagementClient simpleSystemsManagementClient = new Amazon.SimpleSystemsManagement.AmazonSimpleSystemsManagementClient(Amazon.RegionEndpoint.APSoutheast1);
